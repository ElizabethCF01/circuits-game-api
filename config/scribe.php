...
return [
    ...
    'description' => 'API for the Circuits game - a grid-based puzzle game where players collect circuits by navigating through levels.',
    ...
    // For external types: 'scalar' (default), 'elements', or a custom URL
    'theme' => 'scalar',
    ...
    'auth' => [
        ...
        'extra_info' => 'To authenticate, first call the <b>login</b> or <b>register</b> endpoint to get a token. Then include it in the Authorization header as: <code>Bearer {token}</code>',
    ],
