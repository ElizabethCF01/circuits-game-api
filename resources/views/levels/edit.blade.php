                    ...
                    <form action="{{ route('admin.levels.update', $level) }}" method="POST">
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div class="mb-4">
                                ...
                                <x-breeze.text-input id="grid_width" class="block mt-1 w-full" type="number" name="grid_width" :value="old('grid_width', $level->grid_width)" min="1" required />
                                <x-breeze.input-error :messages="$errors->get('grid_width')" class="mt-2" />
                            </div>

                            <div class="mb-4">
                                <x-breeze.input-label for="grid_height" value="Grid Height" />
                                <x-breeze.text-input id="grid_height" class="block mt-1 w-full" type="number" name="grid_height" :value="old('grid_height', $level->grid_height)" min="1" required />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="tiles" name="tiles" rows="6" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm font-mono text-sm" required>{{ old('tiles', json_encode($level->tiles)) }}</textarea>
